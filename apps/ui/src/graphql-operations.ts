...
export type GetBannerQuery = { __typename?: 'Query', banner: { __typename?: 'Banner', name: string, alternativeText: string } };
...
export type GetBannersQuery = { __typename?: 'Query', banners: Array<{ __typename?: 'Banner', id: string, name: string, alternativeText: string, enabled: boolean, createdAt: any, updatedAt: any, width: number, height: number, images?: Array<{ __typename?: 'BannerImage', id: string }> | null }> };
...
export type RemoveBannerMutation = { __typename?: 'Mutation', removeBanner: string };
...
export type CreateBannerMutation = { __typename?: 'Mutation', createBanner: { __typename?: 'Banner', id: string, alternativeText: string, name: string } };
...
export type GetBannerImagesQuery = { __typename?: 'Query', banner: { __typename?: 'Banner', id: string, name: string, images?: Array<{ __typename?: 'BannerImage', id: string, width: number, height: number, type: string, totalBytes: number, path: string, isOriginal: boolean }> | null } };
...
export type UpdateBannerMutation = { __typename?: 'Mutation', updateBanner: { __typename?: 'Banner', id: string, name: string, alternativeText: string, updatedAt: any, width: number, height: number } };
...
export type GetTasksQuery = { __typename?: 'Query', tasks: Array<{ __typename?: 'Task', id: string, draft: boolean, enabled: boolean }> };
...
export const CreateBannerDocument = gql`
    mutation CreateBanner($shopId: ID!, $name: String!, $alternativeText: String!) {
  createBanner(
    shopId: $shopId
 ...
 * });
 */
export function useGetBannerImagesQuery(baseOptions: Apollo.QueryHookOptions<GetBannerImagesQuery, GetBannerImagesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetBannerImagesQuery, GetBannerImagesQueryVariables>(GetBannerImagesDocument, options);
      }
export function useGetBannerImagesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetBannerImagesQuery, GetBannerImagesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetBannerImagesQuery, GetBannerImagesQueryVariables>(GetBannerImagesDocument, options);
        }
export type GetBannerImagesQueryHookResult = ReturnType<typeof useGetBannerImagesQuery>;
export type GetBannerImagesLazyQueryHookResult = ReturnType<typeof useGetBannerImagesLazyQuery>;
export type GetBannerImagesQueryResult = Apollo.QueryResult<GetBannerImagesQuery, GetBannerImagesQueryVariables>;
export const UpdateBannerDocument = gql`
    mutation UpdateBanner($id: ID!, $name: String!, $alternativeText: String!, $width: Int!, $height: Int!) {
  updateBanner(data: {id: $id, name: $name, alternativeText: $alternativeText}) {
    id
    name
    alternativeText
    updatedAt
...
export const UploadBannerImageDocument = gql`
  ...
  uploadBannerImage(data: {id: $id, image: $image})
    ...
    `;
export type UploadBannerImageMutationFn = Apollo.MutationFunction<UploadBannerImageMutation, UploadBannerImageMutationVariables>;
 ...
 * });
 */
export function useUploadBannerImageMutation(baseOptions?: Apollo.MutationHookOptions<UploadBannerImageMutation, UploadBannerImageMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UploadBannerImageMutation, UploadBannerImageMutationVariables>(UploadBannerImageDocument, options);
      }
export type UploadBannerImageMutationHookResult = ReturnType<typeof useUploadBannerImageMutation>;
export type UploadBannerImageMutationResult = Apollo.MutationResult<UploadBannerImageMutation>;
export type UploadBannerImageMutationOptions = Apollo.BaseMutationOptions<UploadBannerImageMutation, UploadBannerImageMutationVariables>;
